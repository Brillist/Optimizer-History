...
UTL_CLASS_IMPL(cls::CompositeResourceRequirement, utl::Object);
...
CompositeResourceRequirement::CompositeResourceRequirement(
    IntActivity* act,
...
CompositeResourceRequirement::compare(const Object& rhs) const
{
    ...
    const CompositeResourceRequirement& cr
        = (const CompositeResourceRequirement&)rhs;
