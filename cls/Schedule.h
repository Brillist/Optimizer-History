...
public:
    ...
    ResourceCalendarMgr* calendarMgr()
    { return _calendarMgr; }

    /** Get the activities array. */
    Activity** activitiesArray() const
    { return _activitiesArray; }

    /** Get the resources array. */
    Resource** resourcesArray() const
    ...
    */
    act_const_iterator activitiesBegin() const
    ...
    */
    ...
    /**
       ...
       the list of managed activities.
    */
    act_const_iterator activitiesEnd() const
    ...
    */
    res_const_iterator resourcesBegin() const
    ...
    */
    ...
    /**
       ...
       the list of managed resources.
    */
    res_const_iterator resourcesEnd() const
