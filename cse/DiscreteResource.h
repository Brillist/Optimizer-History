#ifndef CSE_DISCRETERESOURCE_H
#define CSE_DISCRETERESOURCE_H
...
public:
    ...
    /** Get lhs-op. */
    const JobOp* lhsOp() const
    { return _lhsOp; }

    /** Get rhs-op. */
    const JobOp* rhsOp() const
    { return _rhsOp; }

    /** Get sequence-record. */
    const ResourceSequenceRule* rule() const
    { return _rsr; }
private:
    const JobOp* _lhsOp;
    const JobOp* _rhsOp;
...
public:
    ...
    const ResourceSequenceList* sequenceList() const
    { return _rsl; }

    /** Get resource-sequence-list. */
    const ResourceSequenceList*& sequenceList()
    { return _rsl; }

    /** Get resource-sequence-rule-applications. */
    const rsra_vector_t& sequenceRuleApplications() const
    { return _rsras; }

    /** Get resource-sequence-rule-applications. */
    rsra_vector_t& sequenceRuleApplications()
    { return _rsras; }

    /** Get min-capacity. */
    utl::uint_t minCap() const
    { return _minCap; }
    ...
    utl::uint_t existingCap() const
    { return _existingCap; }

    /** Get existing-capacity */
    utl::uint_t& existingCap()
    { return _existingCap; }
    
    /** Get max-capacity. */
    utl::uint_t maxCap() const
    { return _maxCap; }
    ...
    /** Get selected-capacity. */
    utl::uint_t& selectedCap()
    { return _selectedCap; }

    /** Get cost record. */
    const ResourceCost* cost() const
    { return _cost; }

    /** Set cost record. */
    void setCost(ResourceCost* cost)
    { delete _cost; _cost = cost; }

    /** Get default calendar. */
    const cls::ResourceCalendar* defaultCalendar() const
    { return _defaultCalendar; }

    /** Set default calendar. */
    void setDefaultCalendar(cls::ResourceCalendar* cal)
    { delete _defaultCalendar; _defaultCalendar = cal; }

    /** Get detailed calendar. */
    const cls::ResourceCalendar* detailedCalendar() const
    { return _detailedCalendar; }

    /** Set detailed calendar. */
    void setDetailedCalendar(cls::ResourceCalendar* cal)
    { delete _detailedCalendar; _detailedCalendar = cal; }

    /** Make current calendar. */
    cls::ResourceCalendar* makeCurrentCalendar(
        const SchedulerConfiguration* config) const;

    /** Get the cls-resource. */
    cls::DiscreteResource* clsResource() const
    {
