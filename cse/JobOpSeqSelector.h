#ifndef CSE_JOBOPSEQSELECTOR_H
#define CSE_JOBOPSEQSELECTOR_H
...
{
    UTL_CLASS_DECL(JobOpSeqSelector);
...
private:
    ...
    void setSelectedJobOpSeq(gop::StringInd<utl::uint_t>* ind, SchedulingContext* context) const;
};
