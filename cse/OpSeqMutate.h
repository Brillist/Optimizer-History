#ifndef CSE_OPSEQMUTATE_H
#define CSE_OPSEQMUTATE_H
...
public:
   ...
   */
   ...
   virtual utl::uint_t numActiveSwapOps(
       const jobop_vector_t* opVect);

   virtual JobOp* selectActiveSwapOp(
       const jobop_vector_t* opVect);
private:
...
/*    typedef std::vector<JobOp*> jobop_vector_t; */
   ...
   typedef
       std::map<JobOp*, jobop_vector_t*, JobOpIdOrdering>
       jobop_jobopvector_map_t;
private:
   void init();
   void deInit();
private:
