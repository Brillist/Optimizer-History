...
UTL_CLASS_IMPL(cse::ResourceGroupRequirement, utl::Object);
...
ResourceGroupRequirement::copy(const Object& rhs)
{
    ...
    const ResourceGroupRequirement& rgr
        = (const ResourceGroupRequirement&)rhs;
...
bool
ResourceGroupRequirement::hasNonZeroCapPt(
   const JobOp* op,
   const ResourceGroup* resGroup) const
{
