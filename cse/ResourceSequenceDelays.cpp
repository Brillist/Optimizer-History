...
UTL_CLASS_IMPL(cse::ResourceSequenceDelay, utl::Object);
UTL_CLASS_IMPL(cse::ResourceSequenceDelays, utl::Object);
...
ResourceSequenceDelays::compare(const Object& rhs) const
{
    ...
    res = compareContObjects(
        _resourceSequenceDelays,
        rsd._resourceSequenceDelays);
    return res;
}
