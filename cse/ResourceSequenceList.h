...
public:
    ...
    utl::uint_t lhsOpSequenceId() const
...
typedef std::set<
      ResourceSequenceRule*,
      lut::ObjectSTLordering<ResourceSequenceRule> >
         rsr_set_t;
...
public:
    ...
    const ResourceSequenceRule* findRule(
        utl::uint_t lhsOpSequenceId,
        utl::uint_t rhsOpSequenceId) const;
...
struct ResourceSequenceListOrdering
   : public std::binary_function
     <ResourceSequenceList*,ResourceSequenceList*,bool>
{
   /** Compare two individuals. */
   bool operator()(
      const ResourceSequenceList* lhs,
      const ResourceSequenceList* rhs) const
   {
...
typedef std::set <ResourceSequenceList*, ResourceSequenceListOrdering>
        rsl_set_t;
