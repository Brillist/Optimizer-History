...
public:
    ...
    utl::uint32_t challenge() const
    { return _challenge; }

    utl::uint32_t response() const
    { return _response; }
    ...
    bool hasCommandLog() const
    { return (_commandLog != nullptr); }

    utl::BufferedFileStream& commandLog()
    { ASSERTD(_commandLog != nullptr); return *_commandLog; }
