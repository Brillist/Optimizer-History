...
protected:
    virtual utl::NetServerClient* clientMake(
        utl::FDstream* socket,
    ...
    void addHandler(
        ...
        hfn handler);
    bool allAre(
        const utl::Object* object,
        const utl::RunTimeClass* rtc) const;
...
protected:
    bool _recording;
private:
    virtual void handleCmd(
        utl::NetServerClient* client,
        const utl::Array& cmd);
    ...
    void handle_getBestScoreAuditReport(
        SEclient* client,
        const utl::Array& cmd);
