...
UTL_CLASS_IMPL(mrp::ManufactureItem);
...
void
ManufactureItem::serialize(Stream& stream, uint_t io, uint_t)
{
...
ManufactureItem::toString() const
{
    ...
    str << Item::toString() << '\n'
        ...
        << ", batchSize:" << _batchSize << ", #plans:" << _itemPlans.size();
    itemplan_set_t::iterator it;
    for (it = _itemPlans.begin(); it != _itemPlans.end(); it++)
    {
