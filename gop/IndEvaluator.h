...
public:
    ...
    void auditNext() const
    { _audit = true; }

    /** Get the audit text. */
    const std::string& auditText() const
    { return _auditText; }

    /** Get the component scores. */
    const string_int_map_t& componentScores() const
    ...
    void setComponentScore(
        const std::string& componentName,
        int score) const;

    /** Initialize. */
    virtual void initialize(const IndEvaluatorConfiguration* cf) {}
