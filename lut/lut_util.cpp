...
periodToString(period_t period)
{
    ...
    case period_week: return "week";
    case period_month: return "month";
    case period_year: return "year";
    default: ABORT();
    }
    return "(null)";
}
...
periodToSeconds(period_t period)
{
    switch (period)
    {
    case period_hour: return 60 * 60;
    case period_day: return 24 * 60 * 60;
    case period_week: return 7 * 24 * 60 * 60;
    case period_month: return 30 * 24 * 60 * 60;
    case period_year: return 365 * 24 * 60 * 60;
    default: ABORT();
    }
    return 0;
}
...
time_str(time_t t)
{
    ...
    struct tm* tms = localtime(&t);
    ss << (1900 + tms->tm_year)
       << "/" << std::setfill('0') << std::setw(2) << (tms->tm_mon + 1)
