#ifndef MPS_MPSITEM_H
#define MPS_MPSITEM_H
...
/*     { return _planningHorizon; } */
    ...
    bool allowMPSquantitySplit() const
    { return _allowMPSquantitySplit; }

    /** Whether allow to split MPS quantity */
    bool& allowMPSquantitySplit()
    { return _allowMPSquantitySplit; }

    /** all MPS periods. */
    const mpsitemperiod_set_st_t& periods() const
    { return _periods; } 

    /** all MPS periods. */
    mpsitemperiod_set_st_t& periods()
    { return _periods; }
    //@}
