#ifndef MPS_MPSITEMPERIOD_H
#define MPS_MPSITEMPERIOD_H
...
public:
    ...
    utl::uint_t customerOrder() const
    ...
    /** Status. */
    mpsitemperiod_status_t status() const
    { return _status; }
...
typedef std::set<MPSitemPeriod*, MPSitemPeriodOrderingIncId>
    mpsitemperiod_set_id_t;
typedef std::set<MPSitemPeriod*, MPSitemPeriodOrderingIncItemId> 
    mpsitemperiod_set_itemid_t;
typedef std::set<MPSitemPeriod*, MPSitemPeriodOrderingIncST>
