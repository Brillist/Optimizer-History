#ifndef MRP_INVENTORYRECORD_H
#define MRP_INVENTORYRECORD_H
...
public:
    ...
    /** Period type. */
    inventory_period_t periodType() const
    { return _periodType; }

    /** Period type. */
    inventory_period_t& periodType() 
    { return _periodType; }

    /** Number of periods. */
    utl::uint_t numberOfPeriods() const
    { return _numberOfPeriods; }

    /** Number of periods. */
    utl::uint_t& numberOfPeriods()
    { return _numberOfPeriods; }

    /** Safety stock. */
    utl::uint_t safetyStock() const
    { return _safetyStock; }

    /** Safety stock. */
    utl::uint_t& safetyStock()
    { return _safetyStock; }

    /** On-hand. */
    utl::uint_t onHand() const
    { return _onHand; }
    ...
    const inventorytransaction_set_time_t& invTransactions() const
    { return _invTransactions; }

    /** Inventory Record Periods. */
    inventorytransaction_set_time_t& inventoryTransactions()
    { return _invTransactions; }

    /** Inventory Intervals. */
    const inventoryinterval_set_st_t& intervals() const
    { return _intervals; }

    /** Inventory Intervals. */
    inventoryinterval_set_st_t& intervals()
    { return _intervals; }
    //@}
    ...
    bool checkAvailableCapacity(time_t t, utl::uint_t reqCap)
    { return availableCapacity(t) >= (utl::int_t)reqCap; }

    /** find the earliest availbe time from which there is enough reqCap.*/
    time_t findEarliestAvailableTime(utl::uint_t reqCap,
                                     time_t est = 0,
                                     time_t lst = utl::int_t_max)
    { return 0; }
...
private:
    ...
    utl::int_t minDebitCapacity(
        InventoryInterval* intvl, 
        utl::int_t prevDebit);

    utl::int_t nodeAvailableCapacity(
        InventoryInterval* intvl, 
        utl::int_t leftCap, 
        utl::int_t rightCap);
...
struct InventoryRecordOrderingIncId
    ...
    bool>
{
    bool operator()(InventoryRecord* lhs, InventoryRecord* rhs)
    { return (lhs->id() < rhs->id()); }
};

//////////////////////////////////////////////////////////////////////////////

typedef std::set<InventoryRecord*, InventoryRecordOrderingIncId> 
    inventoryrecord_set_id_t;
