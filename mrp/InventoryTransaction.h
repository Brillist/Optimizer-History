#ifndef MRP_INVENTORYRECORDPERIOD_H
#define MRP_INVENTORYRECORDPERIOD_H
...
public:
    ...
    /** Status. */
    inv_transaction_status_t status() const
    { return _status; }
    ...
    /** Operation Type. */
    inv_transaction_op_type_t opType() const
    { return _opType; }
...
struct InventoryTransactionOrderingIncT 
    ...
    bool>
{
    bool operator()(InventoryTransaction* lhs, 
                    InventoryTransaction* rhs) const;
};

//////////////////////////////////////////////////////////////////////////////

typedef std::set<InventoryTransaction*, 
    InventoryTransactionOrderingIncT> inventorytransaction_set_time_t;
