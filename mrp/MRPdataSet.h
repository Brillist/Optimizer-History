...
public:
    ...
    /** Inventoyr records. */
    const inventoryrecord_set_id_t&
    ...
    /* initialize a MRPdataSet from a list of Arrays sent from 
       the front-end */
    void initialize(utl::Array& setupGroups,
                    utl::Array& resources,
