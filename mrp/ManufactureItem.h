#ifndef MRP_MANUFACTUREITEM_H
#define MRP_MANUFACTUREITEM_H
...
public:
    ...
    //@{
    /** Batch size. */
    utl::uint_t batchSize() const
    { return _batchSize; }

    /** Batch size. */
    utl::uint_t& batchSize()
    { return _batchSize; }

    /** Item Plan Relations. */
    const itemplan_set_t& itemPlans() const
    { return _itemPlans; }

    /** Item Plan Relations. */
    itemplan_set_t& itemPlans()
    { return _itemPlans; }
