...
UTL_CLASS_IMPL(mrp::ProcessPlan, utl::Object);
...
bool
PlanOrderingIncId::operator()(
    const ProcessPlan* lhs,
    const ProcessPlan* rhs) const
{
...
ProcessPlan::toString() const
{
    ...
    for (planstep_vector_t::const_iterator it = _plansteps.begin();
         it != _plansteps.end(); it++)
    {
