...
UTL_CLASS_IMPL(mrp::PurchaseOrder, utl::Object);
...
bool
PurchaseOrderIdOrdering::operator()(
    const PurchaseOrder* lhs,
    const PurchaseOrder* rhs) const
{
...
bool
PurchaseOrderOdateOrdering::operator()(
    const PurchaseOrder* lhs,
    const PurchaseOrder* rhs) const
{
