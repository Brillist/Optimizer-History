...
public:
    ...
    /** Get the status. */
    purchaseorder_status_t status() const
    { return _status; }

    /** Get the status. */
    purchaseorder_status_t& status()
    { return _status; }

    /** Get the requester id. */
    utl::uint_t requesterId() const
    { return _requesterId; }
    ...
    requester_type_t requesterType() const
    { return _requesterType; }

    /** Get the requester type. */
    requester_type_t& requesterType()
    { return _requesterType; }
    //@}
