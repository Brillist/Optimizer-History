...
public:
    ...
    { ASSERTD(idx < numCapPts()); cap = _caps[idx]; pt = _pts[idx]; }

    /** Get setupId. */
    utl::uint_t getSetupId(utl::uint_t idx)
    { ASSERTD(idx < numCapPts()); return _setupIds[idx]; }
    ...
    void addCapPt(utl::uint_t cap, utl::uint_t pt,
                  rescappt_pt_per_t ptPer, utl::uint_t ptBatchSize,
                  utl::uint_t setupId);
    //@}
