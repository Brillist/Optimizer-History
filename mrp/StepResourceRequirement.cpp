...
UTL_CLASS_IMPL(mrp::StepResourceRequirement, utl::Object);
...
StepResourceRequirement::copy(const Object& rhs)
{
    ...
    const StepResourceRequirement& psrr
        = (const StepResourceRequirement&) rhs;
...
{
    cse::ResourceGroupRequirement* resGroupReq =
        new cse::ResourceGroupRequirement();
