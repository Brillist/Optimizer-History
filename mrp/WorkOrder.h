...
public:
    ...
    /** MPS item period ids. */
    lut::uint_set_t mpsItemPeriodIds() const
    { return _mpsItemPeriodIds; }

    /** MPS item period ids. */
    lut::uint_set_t& mpsItemPeriodIds()
    { return _mpsItemPeriodIds; }

    /** Quantity. */
    utl::uint_t quantity() const
    { return _quantity; }
    ...
    /** Get the status. */
    workorder_status_t status() const
    { return _status; }

    /** Get the status. */
    workorder_status_t& status()
    { return _status; }
...
struct WorkOrderIdOrdering
    : public std::binary_function<WorkOrder*,WorkOrder*,bool>
{
    bool operator()(const WorkOrder* lhs, const WorkOrder* rhs) const
    {
